...
//       }
//
//       //$scope.imagen = ['mujer1.fw.png','mujer2.fw.png'];
//       //$scope.imagenIndex = 0;
//
//       $scope.sliderCambio1 = function() {
//         var img1 = document.getElementById('imagen1');
//         img1.style.opacity = $scope.s1;
//         //img1.src = $scope.imagen[$scope.imagenIndex];
//         //$scope.imagenIndex =$scope.imagenIndex;
//
//
...
//         //img2.src = $scope.imagen[$scope.imagenIndex];
//         //$scope.imagenIndex =$scope.imagenIndex;
//
//
